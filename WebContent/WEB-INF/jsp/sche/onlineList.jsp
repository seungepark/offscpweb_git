...
<%-- 				<%@ include file="/WEB-INF/jsp/include/menu/bread_1_2.jsp"%> --%>
				...
				<div class="tb-area">
					<div class="d-flex flex-row-reverse">
						<button class="bt-obj bt-primary" onclick="popDownModal()"><img src="${pageContext.request.contextPath}/img/new/save.png" class="bt-icon"><span data-i18n="btnDownload"></span></button>
					</div>
					<div class="sp-16"></div>
					<div class="tb-wrap">
    	...
    	<div class="modal-dialog modal-dialog-centered" role="document">
      		<div class="modal-content">
      			<div class="modal-body text-center pop-alert">
		        	<div class="pop-alert-title" data-i18n="downPop.title"></div>
		        	<div class="pop-alert-msg" data-i18n="downPop.msg"></div>
          			<button type="button" class="bt-obj bt-secondary" data-dismiss="modal" data-i18n="downPop.btnClose"></button>
		        	<button type="button" class="bt-obj bt-primary" onClick="download()">
          				<img src="${pageContext.request.contextPath}/img/new/save.png" class="bt-icon" height="16px">
						<span data-i18n="downPop.btnDown"></span>
          			</button>
				</div>
      		</div>
    	</div>
...
<script src="${pageContext.request.contextPath}/js/sche/onlineList.js"></script>
</body>
</html>