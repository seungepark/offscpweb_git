      		...
      		<div class="modal-content">
        		...
        		<div class="modal-footer">
       				<div class="text-primary mr-5">
       					<div data-i18n="submitPop.rollbackMsg"></div>
       					<div id="submitPopUploadMsg" class="text-danger" data-i18n="submitPop.uploadMsg"></div>
       				</div>
					...
					<button id="submitPopBtnUpload" class="bt-obj bt-primary" onclick="upload()"><img src="${pageContext.request.contextPath}/img/i_upload.svg" class="bt-icon" height="16px"><span data-i18n="submitPop.btnUp"></span></button>
        		</div>
      		</div>
    	</div>
  	</div>
