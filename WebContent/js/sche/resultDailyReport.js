...
function showSubmitPop() {
	...
	$('#submitPopUploadMsg').hide();
	$('#submitPopBtnUpload').hide();
				...
				success: function(data) {
					try {
						...
						if(json.result) {
							...
							if(error) {
								toastPop($.i18n.t('share:notConn'));
							}else if(isEmpty(code) || code == 'DEPART') {
								_status = code;
								toastPop($.i18n.t('error.statusDepart'));
							}else if(code == 'ARRIVE') {
								_status = code;
								...
								toastPop($.i18n.t('share:firstUpload'));
								$('#submitPopUploadMsg').show();
								$('#submitPopBtnUpload').show();
							}else if(code == 'EEI') {
		...
		success: function(data) {
			...
			try {
				...
				if(msg == 'ERR') {
					...
					toastPop($.i18n.t('submitPop.compUp'));
					$('#submitPopUploadMsg').hide();
					$('#submitPopBtnUpload').hide();
				}else {
					toastPop($.i18n.t('share:tryAgain'));
