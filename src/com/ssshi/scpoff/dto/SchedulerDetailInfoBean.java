...
public class SchedulerDetailInfoBean {
	...
	private List<ScheDateTimeBean> dateTimeList;
	private List<ScheTcNoteBean> tcNoteList;
	...
	public List<ScheDateTimeBean> getDateTimeList() {
		return dateTimeList;
	}
	public void setDateTimeList(List<ScheDateTimeBean> dateTimeList) {
		this.dateTimeList = dateTimeList;
	}
	public List<ScheTcNoteBean> getTcNoteList() {
		return tcNoteList;
	}
	public void setTcNoteList(List<ScheTcNoteBean> tcNoteList) {
		this.tcNoteList = tcNoteList;
	}
