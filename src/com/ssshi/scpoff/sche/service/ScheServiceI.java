...
public interface ScheServiceI {
	...
	Map<String, Object> onlineList() throws Exception;
	
	Map<String, Object> getScheListForOnline(SchedulerInfoBean bean) throws Exception;
	
	Map<String, Object> onlineDownload(HttpServletRequest request, ParamBean bean) throws Exception;
	
	Map<String, Object> offList() throws Exception;
	...
	Map<String, Object> searchEmail(ParamBean bean) throws Exception;
	
	void upload(HttpServletRequest request, HttpServletResponse response, ParamBean bean) throws Exception;
	
	Map<String, Object> changeOn(HttpServletRequest request, ParamBean bean) throws Exception;
